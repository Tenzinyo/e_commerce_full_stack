...
Step 1. Inside Backend folder:
    pip3 install  django djangorestframework psycopg2-binary python-dotenv ---download dependencies
    django-admin startproject backend . --- create a backend folder inside the parent dir
    python3 manage.py startapp store --- create a app folder and name it store since its e-commerce platform
